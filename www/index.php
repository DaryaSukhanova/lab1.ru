...
<body>
   ...
   // $element11 =  $_POST['element11'];is_numeric
   $element12 = is_numeric($_POST['element12']) ? $_POST['element12']: 0;
   $element13 = is_numeric($_POST['element13']) ? $_POST['element13']: 0;
   $element21 = is_numeric($_POST['element21']) ? $_POST['element21']: 0;
   $element22 = is_numeric($_POST['element22']) ? $_POST['element22']: 0;
   $element23 = is_numeric($_POST['element23']) ? $_POST['element23']: 0;
   $element31 = is_numeric($_POST['element31']) ? $_POST['element31']: 0;
   $element32 = is_numeric($_POST['element32']) ? $_POST['element32']: 0;
   $element33 = is_numeric($_POST['element33']) ? $_POST['element33']: 0;
